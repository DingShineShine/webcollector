 ...
 * @author ding
 * @Description
 * @date 2018/05/12-13:34
 */
@Slf4j
public class DouyuTitleCrawler extends BreadthCrawler {
    public DouyuTitleCrawler(String crawlPath, boolean autoParse) {
        super(crawlPath, autoParse);
        this.addSeed("https://www.douyu.com/directory");
        this.addRegex("https://www.douyu.com/directory/game/\\w+");
        this.addRegex("https://www.douyu.com\\d+");
        setThreads(5);
        getConf().setTopN(100).setConnectTimeout(5000).setReadTimeout(5000);
    }
    ...
    public void visit(Page page, CrawlDatums crawlDatums) {
        ...
        log.error(url);
        try {
            if (page.matchUrl("https://www.douyu.com/t/\\w+") ||
                    page.matchUrl("https://www.douyu.com\\d+")) {
    ...
    public static void main(String[] args) throws Exception {
        DouyuTitleCrawler crawl = new DouyuTitleCrawler("crawl", true);
